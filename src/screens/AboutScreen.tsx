...
const SCREENSHOTS = [
  "/images/child_tablet_app_screen_1782793936255.jpg",
  "/images/child_tablet_app_screen_2_1782793952854.jpg",
  "/images/child_tablet_app_screen_3_1782793967620.jpg",
  "/images/child_tablet_app_screen_1782793936255.jpg",
  "/images/child_tablet_app_screen_2_1782793952854.jpg",
  "/images/child_tablet_app_screen_3_1782793967620.jpg"
];
...
const FEATURES = [
  {
    icon: <img src="/images/feature_icon_book_1782793511748.jpg" alt="Book" className="w-full h-full object-cover rounded-full mix-blend-multiply" />,
  ...
  {
    icon: <img src="/images/feature_icon_bell_1782793523705.jpg" alt="Bell" className="w-full h-full object-cover rounded-full mix-blend-multiply" />,
  ...
  {
    icon: <img src="/images/feature_icon_calendar_1782793539532.jpg" alt="Calendar" className="w-full h-full object-cover rounded-full mix-blend-multiply" />,
  ...
  {
    icon: <img src="/images/feature_icon_chat_1782793548675.jpg" alt="Chat" className="w-full h-full object-cover rounded-full mix-blend-multiply" />,
    ...
    <div className="min-h-screen bg-[#FCFCFD] font-sans flex flex-col relative overflow-hidden">
      ...
      <main className="relative z-10 flex-1 max-w-[1440px] w-full mx-auto px-3 md:px-8 py-6 md:py-8 space-y-8 md:space-y-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-4 space-y-6 md:space-y-4 lg:space-y-8 self-start pt-2 md:pt-0">
            <div className="space-y-2.5 md:space-y-3.5 lg:space-y-4 text-center lg:text-left px-2 md:px-0 flex flex-col items-center lg:items-start">
              {/* App Logo - Only Mobile Hero */}
              <div className="md:hidden">
                <motion.div 
                  initial={{ scale: 0.8, opacity: 0 }}
                  whileInView={{ scale: 1, opacity: 1 }}
                  viewport={{ once: true }}
                  className="w-16 h-16 md:w-20 md:h-20 bg-white rounded-2xl flex items-center justify-center border border-[#FF7A90]/20 overflow-hidden shadow-sm p-1"
                >
                  <img src="/logo_edukid.png" alt="Edukid Logo" className="w-full h-full object-cover" />
                </motion.div>
              </div>

              <div className="space-y-1 md:space-y-1.5 lg:space-y-2">
                <h1 className="text-[22px] md:text-[28px] lg:text-[40px] font-display font-bold text-[#1E3A8A] leading-tight tracking-tight">
                  Giới thiệu Edukid
                </h1>
                <p className="text-[#FF7A90] font-bold text-[14px] md:text-[16px] lg:text-[18px] leading-tight">
                  Đồng hành cùng bé — Học vui mỗi ngày
                </p>
              </div>

              <p className="text-slate-500 text-[13px] md:text-[14px] lg:text-base leading-relaxed font-medium pt-0.5 max-w-[540px]">
            ...
            <div className="space-y-3 md:space-y-3.5 lg:space-y-5 px-1 md:px-0">
              {FEATURES.map((f, idx) => (
          ...
          <div className="md:col-span-1 lg:col-span-4 flex flex-col justify-center self-start pt-6 md:pt-0 lg:pt-12 relative px-2 md:px-0 order-2 lg:order-3">
             <motion.div 
                initial={{ opacity: 0, y: 10 }}
                animate={{ opacity: 1, y: 0 }}
                className="bg-white rounded-[24px] p-6 md:p-8 border border-gray-100 shadow-[0_20px_40px_rgba(28,45,90,0.06)] space-y-5 md:space-y-6 w-full max-w-[340px] md:max-w-full lg:max-w-[340px] mx-auto relative lg:mt-0 md:mt-0"
             >
                {/* Mascot Icon - Positioned differently on Tablet */}
                <div className="hidden md:flex lg:hidden justify-center mb-2">
                  <div className="w-16 h-16 bg-white rounded-2xl flex items-center justify-center border border-[#FF7A90]/20 overflow-hidden shadow-sm p-1">
                    <img src="/logo_edukid.png" alt="Edukid Logo" className="w-full h-full object-cover" />
                  </div>
                </div>
                ...
                <motion.div
                  ...
                  className="absolute -top-8 -right-4 md:-top-10 md:-right-6 w-16 h-16 md:w-20 md:h-20 z-20 pointer-events-none hidden lg:block"
                >
                ...
                <div className="pt-3 md:pt-4 flex justify-center items-center gap-6 md:gap-8 border-t border-gray-50 relative mt-1 md:mt-2">
                   ...
                   <div className="flex flex-col items-center gap-1.5 relative z-10 transition-transform hover:scale-105">
                     <div className="w-14 h-14 md:w-16 md:h-16 bg-white p-1 rounded-xl shadow-sm border border-gray-100 flex items-center justify-center relative overflow-hidden">
                        <img 
                          src="/qr-code-apple.png" 
